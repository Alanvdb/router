...
{
    /**
     * @var RouteIteratorInterface&LazyContainerInterface $routes
     */
    protected RouteIteratorInterface&LazyContainerInterface $routes;

    /**
     * UriGenerator constructor.
     *
     * @param RouteIteratorInterface&LazyContainerInterface $routes
     */
    public function __construct(RouteIteratorInterface & LazyContainerInterface $routes)
    {
        $this->routes = $routes;
    }
